...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        globalConfig.setOutputDir("D:\\JAVA\\ZI\\guns\\guns-admin\\src\\main\\java");//写自己项目的绝对路径,注意具体到java目录
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setPassword("118525");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/guns?characterEncoding=utf8&serverTimezone=UTC&useSSL=false");
    }
